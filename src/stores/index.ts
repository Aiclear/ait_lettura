...
import { createBookmarkSlice } from "@/stores/createBookmarkSlice";
...
import type { BookmarkSlice } from "@/stores/createBookmarkSlice";

export const useBearStore = create<
  FeedSlice & ArticleSlice & UserConfigSlice & PodcastSlice & BookmarkSlice
>()(
